...
public class GrassBendingRTPrePass : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        static readonly RenderTargetIdentifier _GrassBendingRT_rti = new RenderTargetIdentifier(
            _GrassBendingRT_pid
        );
        ...
        )
        {
            ...
            cmd.GetTemporaryRT(
                _GrassBendingRT_pid,
                new RenderTextureDescriptor(512, 512, RenderTextureFormat.R8, 0)
            );
        ...
        )
        {
            ...
            {
                //Debug.LogWarning(
                //    "InstancedIndirectGrassRenderer not found, abort GrassBendingRTPrePass's Execute"
                //);
                return;
            }
            ...
            Matrix4x4 viewMatrix = Matrix4x4
                .TRS(
                    InstancedIndirectGrassRenderer.instance.transform.position
                        + new Vector3(0, 1, 0),
